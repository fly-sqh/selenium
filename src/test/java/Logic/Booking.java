...
public class Booking {
    public static void Online(WebDriver dr) throws InterruptedException {
        //online批量下单
        FindElement.findElements(OnlinePage.createorder).get(1).click();//切换frame，点击批量下单按钮
        /*FindElement.findElement(OnlinePage.selectfile).sendKeys("C:\\Users\\admin\\Documents\\Automation\\online下单.xlsx");
        FindElement.findElement(OnlinePage.submit).click();//点击提交按纽
        dr.switchTo().defaultContent();
        String ordermassge=FindElement.findElement(OnlinePage.massge).getAttribute("innerHTML");
